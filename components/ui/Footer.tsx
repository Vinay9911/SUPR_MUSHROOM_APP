...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-brand-dark dark:bg-[#0a0d12] text-white py-16 px-4 sm:px-6 lg:px-8 mt-auto border-t border-brand-brown/30 dark:border-white/10 relative z-10 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="col-span-1 flex flex-col items-center md:items-start">
          <div className="mb-6">
            <Image
              ...
              width={120}
              height={120}
              className="h-[100px] md:h-[120px] w-auto object-contain opacity-90"
              priority
            />
          </div>
          <p className="text-sm leading-relaxed text-white/70 max-w-xs mx-auto md:mx-0">Delivering the freshest, scientifically farmed mushrooms in Delhi NCR. Grown in sterile, chemical-free environments for pure taste and nutrition.</p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start pt-8 md:pt-12">
          ...
          <ul className="space-y-4 text-sm text-white/70 w-full">
            ...
            <li><Link href="/blog" className="hover:text-white hover:underline transition-colors block p-1">Mushroom Blog</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-white/10 flex justify-center text-xs text-white/50">
