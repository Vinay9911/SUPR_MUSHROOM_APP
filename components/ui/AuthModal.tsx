...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-bg-color rounded-3xl w-full max-w-md p-8 shadow-2xl animate-in zoom-in-95">
        ...
        {view !== 'forgot' && (
          <div className="mt-4">
            <button onClick={handleGoogleLogin} className="w-full bg-white dark:bg-brand-light border border-brand-cream dark:border-brand-cream/20 text-brand-text font-medium py-3 rounded-xl hover:bg-brand-light dark:hover:bg-brand-cream/10 transition-colors flex items-center justify-center gap-2">
